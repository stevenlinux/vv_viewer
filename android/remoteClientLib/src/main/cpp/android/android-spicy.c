                               ...
                               gpointer data)
{
    ...
    case SPICE_CHANNEL_CLOSED:
        ...
        sendMessage(NULL, 5, "Connection failed."); /* SPICE_CONNECT_FAILURE */
    ...
    case SPICE_CHANNEL_ERROR_TLS:
        ...
        sendMessage(NULL, 45, "TLS error."); /* SPICE_TLS_ERROR */
        connection_disconnect(conn);
        break;
    case SPICE_CHANNEL_ERROR_LINK:
        ...
        sendMessage(NULL, 5, "Link failed."); /* SPICE_CONNECT_FAILURE */
        connection_disconnect(conn);
        break;
    ...
    case SPICE_CHANNEL_ERROR_AUTH:
        ...
        strcpy(password, "");
        sendMessage(NULL, 20, "Authentication failed."); /* GET_SPICE_PASSWORD */
        connection_disconnect(conn);
        break;
    default:
...
void connection_disconnect(spice_connection *conn)
{
    ...
    // Clear global_conn immediately to avoid stale pointer on re-connect
    if (global_conn == conn) {
        global_conn = NULL;
    }
