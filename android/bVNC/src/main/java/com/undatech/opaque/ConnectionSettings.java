...
public class ConnectionSettings extends AbstractConnectionBean implements Serializable {
    ...
    private boolean requestingNewDisplayResolution = false;
    ...
    public void loadAdvancedSettings(Context context, String file) {
        ...
        requestingNewDisplayResolution = sp.getBoolean("requestingNewDisplayResolution", false);
